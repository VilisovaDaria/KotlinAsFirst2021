...
fun whichRookThreatens(
    ...
    return when {
        ...
        notDangerFromRook2 && !notDangerFromRook1 -> 1
        notDangerFromRook1 && !notDangerFromRook2 -> 2
        else -> 3
    }
}
...
fun rookOrBishopThreatens(
    ...
    val notDangerFromBishop = abs(kingX - bishopX) != abs(kingY - bishopY)
    return when {
        notDangerFromBishop && !notDangerFromRook -> 1
        notDangerFromRook && !notDangerFromBishop -> 2
...
fun segmentLength(a: Int, b: Int, c: Int, d: Int): Int =
    when {
        c in a..b && (c == d || c == b && d >= b) || c < a && d == a ||
                a in c..d && b - a == 0 -> 0
        c in a..b && (c == a && (d in (a + 1) until b || d == b) || d < b) ->
            d - c
